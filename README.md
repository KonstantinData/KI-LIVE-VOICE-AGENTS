...
| Tenant `liquisto` | Olivia: interne, toolfreie Assistenz für Information und nicht ausführbare Entwürfe; Voice bis zum Mitarbeiter-Auth-Gate fail-closed ([Vertrag](docs/liquisto-assistant-runtime.md)) |
